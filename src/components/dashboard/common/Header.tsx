            ...
            <div className="flex items-center gap-5">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="ghost" className="relative group flex items-center gap-3 h-auto py-1.5 px-2 hover:bg-slate-50 rounded-2xl transition-all border border-transparent hover:border-slate-200 shadow-none">
                    ...
                    <DropdownMenuContent align="end" className="w-64 p-2 rounded-2xl border border-slate-200 shadow-xl animate-in fade-in zoom-in duration-200">
            ...
            <Dialog open={logoutDialogOpen} onOpenChange={setLogoutDialogOpen}>
                <DialogContent className="sm:max-w-[400px] rounded-3xl p-8 border-none shadow-2xl overflow-hidden">
                    ...
                    <DialogHeader className="pt-4">
                        ...
                        <DialogTitle className="text-2xl font-black text-center text-slate-900">Confirm Sign Out</DialogTitle>
