...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full bg-black/40 backdrop-blur-sm rounded-xl shadow-lg p-10">
        {/* Logo */}

        <div className="text-start">

          {/* Title */}
          <h2 className="text-start text-primary text-2xl font-semibold mb-2">
            Welcome
          </h2>
          <p className="text-start text-white text-sm mb-8">
