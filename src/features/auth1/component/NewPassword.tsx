...
const NewPassword = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center  px-4">
            <div className="w-full  bg-black/40 backdrop-blur-sm rounded-xl shadow-md px-10 py-12">
                {/* Logo */}
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full mt-8 bg-primary hover:bg-primary/90 text-white text-lg font-medium py-4 rounded-lg transition-colors disabled:opacity-50"
                    >
